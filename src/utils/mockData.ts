...
import { generateId, formatDateTime } from './dateUtils';
...
export const initialOrders: Order[] = [
  {
    id: generateId(),
    bedId: initialBeds[1].id,
    bedNumber: initialBeds[1].bedNumber,
    ward: initialBeds[1].ward,
    userPhone: '138****5678',
    status: 'active',
  ...
  {
    id: generateId(),
    bedId: initialBeds[0].id,
    bedNumber: initialBeds[0].bedNumber,
    ward: initialBeds[0].ward,
    userPhone: '139****1234',
    status: 'completed',
  ...
  {
    id: generateId(),
    bedId: initialBeds[4].id,
    bedNumber: initialBeds[4].bedNumber,
    ward: initialBeds[4].ward,
    userPhone: '137****9999',
    status: 'completed',
...
export const initialRecords: ExceptionRecord[] = [
  {
    id: generateId(),
    orderId: initialOrders[1].id,
    bedNumber: initialOrders[1].bedNumber,
    type: 'night_cap',
  ...
  {
    id: generateId(),
    orderId: initialOrders[2].id,
    bedNumber: initialOrders[2].bedNumber,
    type: 'bed_damage',
